function renderSidebar() {
  ...
  sidebarContainer.innerHTML = `
    ...
    <aside id="sidebar-menu" class="fixed inset-y-0 left-0 transform -translate-x-full md:relative md:translate-x-0 transition-transform duration-300 ease-in-out w-64 bg-emerald-900 text-white p-6 flex flex-col justify-between border-r border-emerald-950 min-h-screen z-40 pt-20 md:pt-6">
      <div>
      ...
      <div class="pt-4 border-t border-emerald-800/60 px-2">
  ...
  // Pasang Event Listener klik ke tombol dan overlay latar belakang
  menuToggle.addEventListener("click", toggleMenu);
  sidebarOverlay.addEventListener("click", toggleMenu);

  // CRITICAL: Menginisialisasi & merender class 'data-lucide' menjadi SVG asli Lucide
